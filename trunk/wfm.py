...
<table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    <tr>
      <td class="topdomain"><!-- domain --><br>
      </td>
    </tr>
    <tr>
      <td style="vertical-align: top; background-color: rgb(44, 89, 224); color: white; cursor: default;"><!-- folder --><br>
      </td>
    </tr>
    <tr>
      <td style="vertical-align: top; background-color:#FFFF99; color: rgb(44, 89, 224); cursor: default;"><!-- realfolder --><br>
      </td>
    </tr>
    <tr>
    ...
    if file_ext.lower() != ".zip":    
      ...
      strFiles += "  <tr class='rowfile'>\r\n" + \
                ...
                """    <td><a href="javascript:delfile('""" + name + """');" title='delete file'><div class='headdelfile'></div></a></td>\r\n""" + \
                  "    <td width='59%'><a class='filelink' target='_blank' title='open document in a new web browser page' " + \
                  "        href='" + joinPath(joinPath(rootpos, vfolder), name) + "' >" + (name) + "</a></td>\r\n" + \
